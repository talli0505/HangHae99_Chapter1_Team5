...
for music_2000 in genie_2000:
    ...
    doc ={'rank': rank_2000, 'title': title_2000, 'star': artist_2000}
...
for music_2010 in genie_2010:
    ...
    doc = {'rank': rank_2010, 'title': title_2010, 'star': artist_2010}
...
for music_2020 in genie_2020:
    ...
    doc = {'rank': rank_2020, 'title': title_2020, 'star': artist_2020}
